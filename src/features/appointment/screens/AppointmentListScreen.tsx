                ...
                {loading ? (
                    ...
                    appointments.map((appointment) => (
                        ...
                        >
                                ...
                                <View className='flex-row items-center gap-3 flex-1'>
                                    ...
                                    <View className='flex-1'>
                                        ...
                                        <View
                                            ...
                                            style={{ backgroundColor: `${appointmentTypeColors[appointment.type]}15` }}
                                        >
                                            <Text className='text-xs font-medium' style={{ color: appointmentTypeColors[appointment.type] }}>
                            ...
                            <View className='flex-row items-center gap-4 pt-3 border-t' style={{ borderColor: '#E5E7EB' }}>
