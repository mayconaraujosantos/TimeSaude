...
export type MedicationForm = 'tablet' | 'capsule' | 'syrup' | 'injection' | 'drops' | 'cream' | 'spray' | 'patch' | 'other';
export type DosageUnit = 'mg' | 'ml' | 'g' | 'mcg' | 'unit' | 'drop' | 'puff' | 'tablet' | 'capsule';
...
export type UpdateMedicationInput = Partial<Omit<Medication, 'id' | 'userId' | 'createdAt' | 'updatedAt'>>;
